...
$string['settings:copyright'] = 'Copyright Tag';
$string['settings:copyright_default'] = 'Created by Brickfield Translator https://www.brickfield.ie/translator/';
$string['settings:copyright_desc'] = 'Text for Copyright Tag for PHP File.';

...
/**
 * Dutch language pack for local_bftranslate.
 *
...
$string['apikey:deeplfree'] = 'DeepL Free API-sleutel';
$string['apikey:deeplfree_desc'] = 'Voer uw DeepL Free API-sleutel in om vertalingen mogelijk te maken.';
$string['apikey:invalid'] = 'Ongeldige API-sleutel ({$a})';
$string['bftranslate:viewall'] = 'Alle functies van de Plugin Vertaler bekijken';
...
$string['copyright_text'] = 'Gemaakt met de Brickfield Plugin Vertaler https://www.brickfield.ie/brickfield-translator/';
$string['emptyplugin'] = 'Geen plugin ingediend';
$string['emptytargetlang'] = 'Geen doeltaal ingediend';
$string['errorsencountered'] = 'Fouten aangetroffen:';
$string['eventrequest_submitted'] = 'Vertaalverzoek ingediend';
$string['eventrequest_submitteddesc'] = 'Vertaalverzoek ingediend, de plugin was \'{$a->plugin}\', de taal was \'{$a->lang}\', de API was \'{$a->api}\', het aantal ingediende tekenreeksen was \'{$a->count}\', de status was \'{$a->status}\'.';
$string['filename'] = 'Vertaler downloaden';
$string['invalidstatedata'] = 'De gegevens van de vertaalsessie konden niet worden gelezen. Start de vertaling opnieuw.';
...
$string['request:success'] = 'Geslaagd';
...
$string['showexisting'] = 'Bestaande tonen';
$string['showexisting_desc'] = 'Toon ook reeds bestaande taalreeksen';
$string['status:existing'] = 'Bestaand';
$string['status:new'] = 'Nieuw';
...
$string['translateerror'] = 'Fout ontvangen van API: {$a}';
$string['translationlabel'] = 'Vertaaltekst voor tekenreekssleutel {$a}';
